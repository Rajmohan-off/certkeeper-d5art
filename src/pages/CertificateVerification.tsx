...
const API_URL = import.meta.env.VITE_SERVER_URL || 'https://d5art.com/api/v1';
...
export default function CertificateVerification() {
  ...
  const handleCopyCredentialId = async () => {
    try {
      await navigator.clipboard.writeText(certificate?.token_id || '');
      setCopied(true);
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-2">
              {certificate.assessment === 'Divershefy' ? 'Professional Member Certificate' : certificate.assessment}
            </h1>
              ...
              <div className="bg-card/50 border border-border/50 rounded-xl p-6 space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="font-mono font-medium text-xs">{certificate.token_id?.slice(0, 20)}...</span>
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-6 w-6"
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="font-medium">
                        {certificate.createdAt ? format(new Date(certificate.createdAt), 'MMM dd, yyyy') : 'N/A'}
                      </span>
                    </div>
                  </div>
